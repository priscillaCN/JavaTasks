...
public class StudentGrade {
    ...
    public static void main(String[] args) {
        ...
        for(int studentIndex = 0; studentIndex < studentsSubjectsAndScores.length; studentIndex++) {
            ...
            for(int scoreIndex = 0; scoreIndex < studentsSubjectsAndScores.length; scoreIndex++) {
            ...
            studentsAverage[studentIndex] = sumOfAllScoresPerStudent / numberOfSubjects;
        ...
        for(int scoreIndex = 0; scoreIndex < numberOfSubjects; scoreIndex++) {
            ...
            System.out.print("SUB " + (scoreIndex + 1) + " \t");
        ...
        for(int studentIndex = 0; studentIndex < studentsSubjectsAndScores.length; studentIndex++) {
            ...
            for(int scoreIndex = 0; scoreIndex < studentsSubjectsAndScores[studentIndex].length; scoreIndex++) {
                System.out.printf("%-5d", studentsSubjectsAndScores[studentIndex][scoreIndex]);
            }

            System.out.printf("%15d", studentsTotal[studentIndex]);
            System.out.printf("%10.2f", studentsAverage[studentIndex]);
            System.out.printf("%5d %n", studentsPosition[studentIndex]);
        ...
        for(int scoreIndex = 0; scoreIndex < studentsSubjectsAndScores.length; scoreIndex++) {
            ...
            highestScore = studentsSubjectsAndScores[scoreIndex][0];

            for(int studentIndex = 0; studentIndex < studentsSubjectsAndScores[scoreIndex].length; studentIndex++) {

                if(studentsSubjectsAndScores[scoreIndex][studentIndex] < 50) failCounter++;
                else passCounter++;
        ...
        for(int scoreIndex = 0; scoreIndex < studentsSubjectsAndScores.length; scoreIndex++) {
            ...
            averageScoreForEachSubject = totalScoreForEachSubject / numberOfStudents;
        ...
        Arrays.sort(highestScoreForeachSubject);
        Arrays.sort(lowestScoreForeachSubject);
...
//
//
//                if(highestScoreForeachSubject[studentsSubjectsAndScores.length - 1] == studentsSubjectsAndScores[studentIndex][scoreIndex]) {
//                    studentWithOverallHighestScore = studentIndex + 1;
//                    subjectWithOverallHighestScore = scoreIndex + 1;
//                    overallHighestScore = studentsSubjectsAndScores[studentIndex][scoreIndex];
//                }
//
//                if(lowestScoreForeachSubject[studentsSubjectsAndScores.length - 1] == studentsSubjectsAndScores[studentIndex][scoreIndex]) {
//                    studentWithOverallLowestScore = studentIndex + 1;
//                    subjectWithOverallLowestScore = scoreIndex + 1;
//                    overallLowestScore = studentsSubjectsAndScores[studentIndex][scoreIndex];
//                }
//
//            }
//
...
//        System.out.println("The overall lowest score is scored by student " + studentWithOverallLowestScore + " in subject " + subjectWithOverallLowestScore + " scoring " + overallLowestScore);
        ...
        classAverageScore = classTotalScore / numberOfStudents;
